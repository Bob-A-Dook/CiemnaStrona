...
text="W przypadku Firefoksa możecie łatwo sprawdzić, gdzie Wasz folder z&nbsp;pamięcią podręczną, wpisując w&nbsp;pasek adresu `about:cache`.  
Swoją drogą to fajny sposób na przeglądanie, co mamy w&nbsp;*cache'u*, bo zawiera również pliki, które nie zostaną zapisane na dysku.  
