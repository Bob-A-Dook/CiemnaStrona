---
layout: post
title: "O ocieplaniu wizerunku szczurów, antykoncepcji i monopolizacji"
subtitle: "Gościnnie wystąpią też akronimy: SNES, DDD i TESCREAL."
description: "Gościnnie wystąpią też akronimy: SNES, DDD i TESCREAL."
date:   2026-04-30 15:17:23 +0100
tags: [Centralizacja, Chemia, Media, Manipulacja]
firmy: [SenesTech]
image:
  path: /assets/posts/centralizacja/szczury-senestech/szczury-monopol-baner.jpg
  width: 1200
  height: 700
  alt: "Przerobiony kadr z filmu animowanego 'Ratatuj', pokazujący kucharza i szczura. Szczur ma na podbrzuszu czerwony znak zakazu, a kucharz ma twarz uśmiechniętego ludka z gry Monopoly."
---
...
Zapraszam w&nbsp;głąb *króliczej*{:.corr-del} szczurzej nory!

<img src="/assets/posts/centralizacja/szczury-senestech/szczury-monopol-baner.jpg" alt="Przerobiony kadr z&nbsp;filmu animowanego 'Ratatuj', pokazujący kucharza i&nbsp;szczura. Szczur ma na podbrzuszu czerwony znak zakazu, a&nbsp;kucharz ma twarz uśmiechniętego ludka z&nbsp;gry Monopoly." />

{:.figcaption}
Źródło: kadr z&nbsp;filmu „Ratatuj”, [ludzik-monopolista](https://wallpapercave.com/wp/wp2445227.jpg) ze strony *wallpapercave.com*, [znak zakazu](https://www.flaticon.com/free-icon/forbidden_2576762) ze strony Flaticon. Przeróbki moje.
...
* [Początek i&nbsp;wątek polski](#początek-iwątek-polski)
* [Wątek amerykański](#wątek-amerykański)
  * [SenesTech](#senestech)
  * [Ekspansja w&nbsp;USA](#ekspansja-wusa)
  * [Narracja marketingowa](#narracja-marketingowa)
* [Wątek globalny](#wątek-globalny)
...
{:.bigspace-before}
<img src="/assets/posts/centralizacja/szczury-senestech/jestem-szczurem-plakaty-przystankowe.jpg" alt="Kolaż pokazujący przystanki autobusowe wyświetlające różne fakty na temat szczurów oraz ich zdjęcia"/>
...
{% include details.html summary="Mikrociekawostki na temat strony" %}
...
Na stronie widać, że ciekawostki to istotnie nie wszystko. Oprócz nich jest też [petycja za zakazem lepów na gryzonie](https://mushika.pl/stoplepom/).
...
Niestety wydaje się, że nie jest to przesada. Nawet [na stronie firmy sprzedającej lepy](https://agrosimex.pl/pulapka-klejowa-na-szczury-i-myszy-ratimor-plus-arkusz) nie owijają w&nbsp;bawełnę:
...
W paru miejscach mignęła mi informacja, że niektórzy używają lepów do łapania, a&nbsp;nie zabijania (używają oleju spożywczego do rozpuszczenia kleju trzymającego zwierzęta).  
Nie sądzę jednak, żeby był to domyślny tryb działania tych pułapek, więc pozostanę przy wersji o&nbsp;ich zabójczym charakterze.

Czyli widzimy, jakiego rodzaju pułapek Fundacja by nie chciała. A&nbsp;jakim metodom panowania nad szczurzą populacją byliby przychylniejsi? 
Na stronie opisujące petycję przedstawiają swoje stanowisko:
...
Jak [napisała na LinkedInie](https://pl.linkedin.com/posts/olga-kazalska_ddd-dialog-integratedpestmanagement-activity-7441744295839313920-JGTx) Olga K. z&nbsp;Fundacji Mushika (eksponująca w&nbsp;nazwie profilu swój tytuł doktorski):
...
{% include details.html summary="Wątek (poboczny) miliarderów i&nbsp;efektywnego altruizmu" %}

{:.bigspace-before}
Na [podstronie Fundacji Mushika](https://mushika.pl/o-nas/) ich prezeska wspomina, że bliskie są jej zasady **efektywnego altruizmu**. Na stronie głównej jest z&nbsp;kolei wzmianka, że kieruje się tym cała fundacja.
...
Mówiąc dokładniej, ta koncepcja to część [TESCREAL](https://en.wikipedia.org/wiki/TESCREAL) -- zestawu poglądów, jakie upodobali sobie miliarderzy, zwłaszcza ci z&nbsp;amerykańskiej Doliny Krzemowej, i&nbsp;jakimi uzasadniają różne swoje działania. Na efektywny altruizm powoływali się na kilka sposobów, ale często cynicznie:
...
{% include info.html
type="Ciekawostka"
text="Skoro już było o&nbsp;miliarderach, to można dodać, że prezeska Fundacji Mushika należy do jednej z&nbsp;20 najbogatszych rodzin w&nbsp;Polsce [według rankingu *Forbesa*](https://echodnia.eu/swietokrzyskie/rodzina-wypychewicz-z-wloszczowy-na-liscie-100-najbogatszych-polakow-forbes-2025-wielki-powrot-i-skok-w-gore/ar/c3-19079430). Zbudowali swój majątek na sprawach ekologicznych (dokładniej: na energii odnawialnej).  
Spółek powiązanych z&nbsp;rodziną jest niemało, ale kluczowa wydaje się [ZPUE](https://rejestr.io/krs/52770/zpue). W&nbsp;jej radzie nadzorczej zasiada kilkoro członków rodziny, w&nbsp;tym prezeska Mushiki. Różne rodzinne spółki (w&nbsp;tym Mushikę) łączy też siedziba we Włoszczowej."
%}
...
{% include info.html
type="Dupochron"
text="Od tego momentu kończy się wątek polski i&nbsp;zaczyna światowy, można zapomnieć o&nbsp;opisanej wyżej Fundacji.  
...
<img src="/assets/posts/centralizacja/szczury-senestech/duckduckgo-senestech.jpg" alt="Szybka podpowiedź z&nbsp;wyszukiwarki DuckDuckGo, wspominająca że producentem antykoncepcji dla szczurów jest firma SenesTech, a&nbsp;ich produkty to ContraPest oraz Evolve"/>

### SenesTech

Co to za firma? Można poczytać o&nbsp;nich [artykuł na Wikipedii](https://en.wikipedia.org/wiki/SenesTech). Pochodzi z&nbsp;Arizony, została założona w&nbsp;2004 roku. Względnie niewielka, ale notowana na giełdzie. A&nbsp;amerykańska giełda może oznaczać parcie na wyniki, dogadywanie się z inwestorami (takimi jak wielkie fundusze) i&nbsp;inne podobne sprawki.
...
{:.bigspace-before}
> **SenesTech** to wiodący producent środków antykoncepcyjnych dla szczurów, w&nbsp;szczególności produktów **ContraPest** i&nbsp;**Evolve**
...
{:.post-meta .bigspace-after}
Względnie niedawno miała miejsce kolejna zmiana i&nbsp;prezesa zastąpiła prezeska. Ale wiele wskazuje na to, że polityka zapoczątkowana przez jej poprzednika trwa do dziś.
...
text="Przykładem produktu wprowadzonego odgórnie był [Bovaer](/2024/12/19/bovaer-kontrowersje){:.internal}, środek zmniejszający ilość metanu wytwarzanego w&nbsp;krowich żwaczach.  
...
Może jakiś artykuł po polsku? Wzmiankę o&nbsp;SenesTechu znajdziemy na portalu opisującym sprawy polonii amerykańskiej, w&nbsp;pewnym [artykule z&nbsp;2 kwietnia 2025&nbsp;roku](https://deon24.com/2025/04/02/czy-szczurza-antykoncepcja-jest-rozwiazaniem-na-problem-z-gryzoniami-trzeba-to-sprawdzic/).  
...
Z kolei *dziennik.com* [opisuje](https://dziennik.com/antykoncepcja-w-walce-ze-szczurza-plaga-w-nowym-jorku-ruszyl-program-pilotazowy/) w&nbsp;artykule z&nbsp;czerwca 2025&nbsp;roku przypadek z&nbsp;Nowego Jorku -- program pilotażowy w&nbsp;dzielnicy Harlem, również oparty na serwowaniu antykoncepcji.  
...
{% include details.html summary="Wątek Flaco i&nbsp;(niejednoznacznych) przyczyn jego śmierci" %}

O zdarzeniu piszą dwa artykuły ze strony *dziennik.com*. Jeden [z lutego](https://dziennik.com/nie-zyje-flaco-slynny-puchacz-z-central-parku-dokonal-zywota-w-piatek-wieczorem/), drugi [z końca marca](https://dziennik.com/nowe-ustalenia-ws-smierci-flaco-w-organizmie-puchacza-wykryto-silne-toksyny/).
...
Co ciekawe, [artykuł z&nbsp;ABC News](https://abcnews.com/US/zoo-releases-final-necropsy-results-flaco-owls-death/story?id=108479170), oparty na raporcie z&nbsp;sekcji zwłok, mówi o&nbsp;trutce krótko, jakby nie była głównym czynnikiem. To wirus od gołębia jest ukazany jako źródło szczególnego spustoszenia:
...
Był przegląd prasy, to może dla odmiany coś ze świata zwykłych internautów? Poszukałem pod hasłem `senestech site:reddit.com` i&nbsp;znalazłem taką [dyskusję na Reddicie](https://old.reddit.com/r/homestead/comments/1dul9u0/rat_control_via_birth_control_senestech_evolve/), którą ktoś rozpoczął, pytając o&nbsp;opinie na temat produktów SenesTechu.
...
Wśród tych komentarzy pojawił się jeden [jednoznacznie promujący produkty SenesTechu](https://old.reddit.com/r/homestead/comments/1dul9u0/rat_control_via_birth_control_senestech_evolve/muuk6fd/). A&nbsp;na końcu komentarza był link do <a href="https://www.realcreativeagency.com/blog/best-way-to-get-rid-of-rats-without-poison/" rel="nofollow">tej strony</a>.

{:.post-meta .bigspace-after}
Usunąłem z&nbsp;końca linku [parametr śledzący](/internetowa_inwigilacja/2021/04/09/internetowa-inwigilacja-parametry){:.internal} `?reddit` -- ewidentnie dodany tam, żeby monitorować liczbę wejść i&nbsp;rozróżniać ich źródło.
...
* Obrzydzanie tradycyjnych trutek, również przez sugerowanie zagrożeń dla ludzi.
  ...
  > _Rat poison is killing pets, wildlife and getting into our water supply_.
...
{:.bigspace}
<img src="/assets/posts/centralizacja/szczury-senestech/euractiv-unijny-zakaz-trutek.jpg" alt="Zdjęcie artykułu z&nbsp;Euractiv pokazujące szczura i&nbsp;podpi mówiący o&nbsp;potrzebie użycia nowych metod"/>
...
{:.post-meta .bigspace-after}
Bardzo mi się to kojarzy z&nbsp;[narracją](/2022/12/24/monsanto-ht-bt-dikamba#kwestia-zwi%C4%99kszonych-oprysk%C3%B3w){:.internal} stosowaną przez koncern Bayer w&nbsp;przypadku środków chwasto- i&nbsp;owadobójczych dla rolnictwa.
...
{:.post-meta .bigspace-after}
Już teraz można dostrzec elementy takiego pozycjonowania, widząc hasztagi typu „FaktyNieMity”, jakimi oznaczane są niektóre wpisy.
...
Swoją drogą te dwie rzeczy łączy nie tylko zbliżone brzmienie. Walka z&nbsp;korpo, jak ta ze szczurami, ma różne oblicza, różniące się zajadłością. I&nbsp;też ma, w&nbsp;tym ostrzejszym wariancie, swoje trzy literki *D* -- słowa *delay, deny, depose* [na nabojach Luigiego M](/2025/01/05/podsumowanie-2024-roku#sprawa-luigiego-mangionego){:.internal}.  
