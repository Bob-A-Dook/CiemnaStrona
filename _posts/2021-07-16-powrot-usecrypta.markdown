...
image: 
   ...
   width: 1200
   height: 700
   alt: "Mem z rysunkowym ludkiem, który nosi uśmiechniętą maskę, a spod niej wygląda zapłakana twarz. Na czole ma logo UseCrypta"
---
...
{% include details.html summary="Szczegóły (poprzedni, tekstowy opis)" %}

{:.post-meta}
W opisie pominąłem niektóre rzeczy; większość wydarzeń w najmniej aktywnej ze spółek Largo (LC3) i niektórych wspólników w LC1, sprzed Jacka K.
...
* *(LC2)*{:.red} 20.04.2012 r. – zarejestrowana zostaje spółka *ABBEY ASSET MANAGEMENT SPÓŁKA Z&nbsp;OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ 3 SPÓŁKA KOMANDYTOWO-AKCYJNA*
  ...
  Wiem, że to dwa różne rodzaje spółek; ale taka jest [dziwna konwencja](https://www.infakt.pl/spolka-z-o-o-spolka-komandytowa-co-to-jest/) przy komandytowych, w których wspólnikiem jest spółka z o.o., co poradzę :roll_eyes:  
...
* (LC1, LC3) 30.04.2019 r. – **wspólnikiem zarówno LC1, jak i LC3 zostaje _LAZAR VISION FUND LP_. Zmiana nazwy LC1 na Q220**.
