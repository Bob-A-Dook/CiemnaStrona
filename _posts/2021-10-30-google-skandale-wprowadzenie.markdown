...
* `Idle Detection API`
  ...
  Daje stronom internetowym [możliwość kontrolowania, czy użytkownik jest aktywny](https://www.theregister.com/2021/09/22/google_emits_chrome_94_with/) (np. czy kliknął w&nbsp;inne okno niż przeglądarka).
